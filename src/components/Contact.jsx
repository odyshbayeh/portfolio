...
const Contact = () => {
  ...
  const SERVICE_ID = "service_eiq64vq"; // Replace with your service ID (e.g., "service_eiq64vq")
  const MAIN_TEMPLATE_ID = "template_3a0u83o"; // Replace with your main template ID (e.g., "template_kfrajk4") //here//
  const AUTO_REPLY_TEMPLATE_ID = "template_su0i2ob"; // Replace with your auto-reply template ID
  const PUBLIC_KEY = "rnoYJ9MEmYxDJkL6Y"; // Replace with your public key (e.g., "9m4xA2k_0DtfHUMo9")
  ...
  return (
    <div
      className={`xl:mt-1 xl:flex-row flex-col-reverse flex gap-2 overflow-hidden`}
    >
      <motion.div
